...
def res2net18_v1b(pretrained=False, **kwargs):
    """Constructs a Res2Net-18_v1b model.
    Args:
        pretrained (bool): No pre-trained models are available, must be False!
    """
    if pretrained:
        raise RuntimeError("Pre-trained models for Res2Net18v1b are not available!")
